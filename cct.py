...
from Models.unetCCT import UNet_CCT
...
def main(config):
    ...
    model  = UNet_CCT(in_chns=3, class_num=1)
    ...
    for epoch in range(epochs):
        ...
        for idx, (batch, batch_w_s) in enumerate(source_dataset):
            ...
            with torch.no_grad():
                ...
                acc_train_sum += acc_train * sup_batch_len
                se_train_sum += se_train * sup_batch_len
                sp_train_sum += sp_train * sup_batch_len
